...
public class ConfigManager
{
    ...
    // config key changes (see UpdateValues / LoadConfig), rather than recompiled on every
    // search. Guarded by its own lock so searches and config writes don't contend on _config.
